...
class CustomerService {
    ...
    static rent(rent, idHouse, idCustomer) {
        return new Promise((resolve, reject) => {
            CustomerService.connect.query(`INSERT INTO ordermanager(checkIn, checkOut, idHouse, idCustomer) VALUES ('${rent.checkIn}', '${rent.checkOut}, ${idHouse}, ${idCustomer})`, (err, data) => {
                if (err) {
                    reject(err)
                }
                else {
