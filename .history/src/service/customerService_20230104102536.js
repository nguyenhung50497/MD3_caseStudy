...
class CustomerService {
    ...
    static rent(rent, idHouse, idCustomer, totalMoney) {
        return new Promise((resolve, reject) => {
            CustomerService.connect.query(`INSERT INTO ordermanager(checkIn, checkOut, idHouse, idCustomer, timeRent) VALUES ('${rent.checkIn}', '${rent.checkOut}', ${idHouse}, ${idCustomer})`, (err, data) => {
                if (err) {
                    reject(err)
                }
                else {
