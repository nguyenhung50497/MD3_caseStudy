    ...
    static getHomeCustomer(homehtml, customers) {
        ...
        customers.map((customer, index) => {
            tbody += `
                    <tr>
                    <td>${index + 1}</td>
                    <td>${customer.nameHouse}</td>
                    <td>${customer.typeRoom}</td>
                    <td>${customer.addressHouse}</td>
                    <td>${customer.amountBedroom}</td>
                    <td>${customer.amountBathroom}</td>
                    <td>${customer.pricePerDay}</td>
                    <td>${customer.description}</td>
                    <td><img src="./media/${house.image}" alt="Image" style="width: 100px;height: 100px;"></td>
                    <td>${customer.statusHouse}</td>
