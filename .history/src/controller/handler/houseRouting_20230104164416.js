            ...
            if (err) {
                ...
                history.map((order, index) => {
                    tbody += `<tr>
                                ...
                                <td>${order.yearOfBirth}</td>
                                <td>${order.addressCustomer}</td>
                                <td><img src="../avatar/${order.avatar}" alt="Image" style="width: 100px;height: 100px;"></td>
                                <td>${order.nameHouse}</td>
                                <td>${order.typeRoom}</td>
                                <td>${order.addressHouse}</td>
                                <td>${order.pricePerDay}$</td>
                                <td><img src="../media/${order.image}" alt="Image" style="width: 100px;height: 100px;"></td>
                                <td>${order.countCustomer}</td>
                                <td>${order.checkIn.toLocaleDateString()}</td>
                                <td>${order.checkOut.toLocaleDateString()}</td>
                            </tr>`
                })
