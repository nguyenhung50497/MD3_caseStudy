        ...
        if (req.method === 'GET') {
            fs.readFile('./views/customer/homeCustomer.html', 'utf-8', async (err, myHouseHtml) => {
                if (err) {
                    ...
                    let myhouse = await CustomerService.findMyHouseById(idCustomer);
                    ...
                    let tbody = `
                            ...
                            `<tr>
                                ...
                                <td>${myhouse[0].amountBedroom}</td>
                                <td>${myhouse[0].amountBathroom}</td>
                                <td>${myhouse[0].pricePerDay}</td>
                                <td>${myhouse[0].description}</td>
                                <td><img src="../../media/${myhouse[0].image}" alt="Image" style="width: 100px;height: 100px;"></td>
                                <td>${myhouse[0].statusHouse}</td>
                                <td>${myhouse[0].countCustomer}</td>
                                <td><a href=""><button class="btn btn-primary">Check out</button></a></td>
                            </tr>`;
