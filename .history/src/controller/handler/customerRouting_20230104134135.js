...
class CustomerRouting {
                ...
                if (err) {
                    ...
                    myhouses.map((myhouse, index) => {
                        tbody += `<tr>
                                    ...
                                    <td>
                                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#cancelModal${myhouse.idHouse}">Cancel</button>
                                        <div class="modal fade" id="cancelModal${myhouse.idHouse}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">No</button>
                                                        <form action="/customer/cancel/${myhouse.idHouse}/${idCustomer}" method="post">
                                    ...
                                    <td>
                                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#checkOutModal${myhouse.idHouse}">Check out</button>
                                        <div class="modal fade" id="checkOutModal${myhouse.idHouse}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">No</button>
                                                        <form action="/customer/checkout/${myhouse.idHouse}/${idCustomer}" method="post">
                                                            <button type="submit" class="btn btn-primary">Yes</button>
                                                        </form>
                                                    </div>
                                                </div>
    ...
    static checkOut(req, res,idHouse, idCustomer) {
