    ...
    static getHomeCustomer(homehtml, customers) {
        ...
        customers.map((customer, index) => {
            tbody += `
                    ...
                    <td><img src="./media/${customer.image}" alt="Image" style="width: 100px;height: 100px;"></td>
                    <td><a href="/house/edit/${customer.idHouse}"><button class="btn btn-primary">Edit</button></a></td>
                    <td>
