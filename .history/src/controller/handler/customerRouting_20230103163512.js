        ...
        if (req.method === 'GET') {
            fs.readFile('./views/house/homeHouseAdmin.html', 'utf-8', async (err, homeHtml) => {
                if (err) {
                    ...
                    homeHtml = CustomerService.getHomeHouse(homeHtml, houses);
            ...
            req.on('end', async err => {
                if (err) {
                    ...
                    const mess = await CustomerService.findByNameHouseContaining(houses.search);
