...
class CustomerRouting {
        ...
        if (req.method === 'GET') {
            fs.readFile('./views/customer/homeCustomer.html', 'utf-8', async (err, myHouseHtml) => {
                if (err) {
                    ...
                    myHouseHtml = myHouseHtml.replace('{id}', idCustomer);
                    let tbody = `<tr>
                                    <td>Number</td>
                                    <td>Name</td>
                                    <td>Type Room</td>
                    ...
                    myhouses.map((myhouse, index) => {
                        tbody += `<tr>
                                    ...
                                    <td>
                                        <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#checkOutModal${myhouse.idHouse}">Check out</button>
                                        <div class="modal fade" id="deleteModal${myhouse.idHouse}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Delete: <span style="color: red; font-size: 36px">${myhouse.nameHouse}</span></h1>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <h3>Are you sure???</h3>
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">No</button>
                                                        <form action="/house/delete/${myhouse.idHouse}" method="post">
                                                            <button type="submit" class="btn btn-danger">Yes</button>
                                                        </form>
                                                    </div>
                                                </div>
    ...
    static checkOut(req, res, idCustomer) {
